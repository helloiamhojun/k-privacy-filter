...
export async function slide01(presentation, ctx) {
  ...
  ctx.addText(slide, {
    text: "OPF의 범용 탐지력에 한국형 Privacy Rule Pack과 문맥 기반 오탐 억제를 결합해, 라이브 데모가 가능한 개인정보 마스킹 시스템을 완성했습니다.",
    x: 66,
    y: 262,
    width: 610,
    height: 70,
  ...
  metric(slide, ctx, 88, 422, 150, "Eval300 F1", "0.7294", "rule-pack 확장 후 replay", C.blue);
