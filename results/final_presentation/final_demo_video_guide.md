...
> 안녕하세요. K-Privacy Filter 최종 시연입니다. 이 시스템은 OpenAI Privacy Filter에 한국형 Privacy Rule Pack과 문맥 기반 오탐 억제를 결합해 한국어 개인정보를 마스킹합니다.
...
> 이 값들은 주민번호나 API key처럼 보이지만 실제 개인정보가 아니라 모델명과 문서 버전입니다. 그래서 일부러 마스킹하지 않습니다. 최종 KPF의 hard-negative FPR 0은 이런 고정 반례 100개 안에서 0개를 잘못 잡았다는 뜻입니다. 전체 오탐률이 0이라는 뜻은 아닙니다.
